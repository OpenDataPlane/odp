...
typedef struct {
	 ...
	 * algorithm is implementation specific. Note that lower priority timers may get delayed due
	 * to higher priority timer processing. All values between zero and 'max_priority'
