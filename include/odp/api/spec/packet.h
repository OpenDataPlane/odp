 ...
 * a referenced packet must not by passed to odp_packet_{push,pull,extend,
 ...
 * packet. odp_packet_is_referenced() returns 1 for the created referencing
 * packet.
 *
...
/**
 * Test if a packet is a references another packet
 *
