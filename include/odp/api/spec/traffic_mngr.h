 ...
 */
typedef struct {
	uint8_t static_ref  :1; /**< Static packet references can be enqueued */
	uint8_t referenced  :1; /**< Referenced packets can be enqueued */
	uint8_t referencing :1; /**< Referencing packets can be enqueued */
