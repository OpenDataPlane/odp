...
typedef struct odp_queue_param_t {
	...
	/** Queue specific cache stashing hints
	  ...
	  * completely for this queue. See
	  * odp_schedule_group_param_t::cache_stash_hints for examples,
	  * configuration applies here similarly. By default, all regions are
	  * disabled (see odp_cache_stash_config_t::regions).
	  *
