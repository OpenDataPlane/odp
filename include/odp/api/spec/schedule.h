 ...
 * odp_schedule_config_t::num_prios. Queues with a higher priority value are
 * served with higher priority than queues with a lower priority value.
 *
 * Maximum priority of groups created with group specific priority span (see
 * odp_schedule_group_param_t::prio), should be queried with
 ...
 * served with higher priority than queues with a lower priority value.
 *
 * Minimum priority of groups created with group specific priority span (see
 * odp_schedule_group_param_t::prio), should be queried with
 ...
 * odp_schedule_config_t::num_prios. The default value should be suitable for
 ...
 *
 * Default priority of groups created with group specific priority span (see
 * odp_schedule_group_param_t::prio), should be queried with
 ...
 * odp_schedule_config_t::num_prios.
 *
 * Priority count of groups created with group specific priority span (see
 * odp_schedule_group_param_t::prio), should be queried with
...
/**
 * Maximum scheduling group specific priority level
 *
 ...
 *
 * @return Maximum scheduling group specific priority level
 */
int odp_schedule_group_max_prio(odp_schedule_group_t group);

/**
 * Minimum scheduling group specific priority level
 *
 ...
 * @param group  Schedule group handle
 *
 * @return Minimum scheduling group specific priority level
 */
int odp_schedule_group_min_prio(odp_schedule_group_t group);

/**
 * Default scheduling group specific priority level
 *
 ...
 * @param group  Schedule group handle
 *
 * @return Default scheduling group specific priority level
 */
int odp_schedule_group_default_prio(odp_schedule_group_t group);

/**
 * Number of scheduling group specific priorities
 *
 ...
 * @param group  Schedule group handle
 *
 * @return Number of scheduling group specific priorities
 */
