...
test_ml_fp32_to_uint16(void)
{
	...
	float fp[12] = {-763.5f, -204.7f, -67.2f, -43.4f, -16.6f,  -3.2f,
			0,	 9.8f,	  36.f,	  497.3f, 1038.1f, 2968.8f};
	uint16_t expected[12] = {0,    317,  1336, 1512, 1711, 1810,
				 1834, 1907, 2101, 5520, 9529, 23841};
	float scale = 0.1349f;
...
test_ml_fp32_from_uint16(void)
{
	...
	float scale = 0.3f;
	uint16_t zero_point = 1834;
	uint16_t u16[6] = {0, 99, 580, 1834, 6347, 28341};
	float expected[6] = {-550.2f, -520.5f, -376.2f, 0.0f, 1353.9f, 7952.1f};
...
test_ml_fp32_to_int16(void)
{
	...
	float fp32[8] = {-182.4f, -32.4f, -7.9, -0.7, 0.0, 1.4f, 12.9f, 360.3f};
	int16_t i16_expected[8] = {-4713, -837, -204, -18, 0, 36, 333, 9310};

	odp_ml_fp32_to_int16(i16, fp32, 8, scale, zero_point);
...
test_ml_fp32_to_int16_positive_zp(void)
{
	...
	float fp32[8] = {-363.7f, -73.6f, -16.4f, -3.4f, 0, 7.5f, 28.6f, 189.3f};
	int16_t i16_expected[8] = {-8715, -1219, 259, 595, 683, 877, 1422, 5574};
...
test_ml_fp32_to_int16_negative_zp(void)
{
	...
	int16_t zero_point = -683;
	float fp32[8] = {-363.7f, -73.6f, -16.4f, -3.4f, 0, 7.5f, 28.6f, 189.3f};
	int16_t i16_expected[8] = {-10081, -2585, -1107, -771, -683, -489, 56, 4208};
...
test_ml_fp32_from_int16(void)
{
	...
	int16_t i16[10] = {-12168, -3425, -322, -21, 0, 62, 327, 1287, 3496, 23957};
	float fp32_expected[10] = {-624.75, -187.6f, -32.45f, -17.4f,  -16.35f,
				   -13.25f, 0.0f,    48.0f,   158.45f, 1181.5f};

	odp_ml_fp32_from_int16(fp32, i16, 10, scale, zero_point);
