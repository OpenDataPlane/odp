...
static crypto_test_reference_t aes_cbc_hmac_sha1_reference[] = {
	{
		.cipher_key_length = AES128_KEY_LEN,
		.cipher_key = { 0x06, 0xa9, 0x21, 0x40, 0x36, 0xb8, 0xa1, 0x5b,
				0x51, 0x2e, 0x03, 0xd5, 0x34, 0x12, 0x00, 0x06},
		...
		.ciphertext = { 0xe3, 0x53, 0x77, 0x9c, 0x10, 0x79, 0xae, 0xb8,
				0x27, 0x08, 0x94, 0x2d, 0xbe, 0x77, 0x18, 0x1a},
		.digest_length = HMAC_SHA1_96_CHECK_LEN,
		.digest = { 0xa9, 0xcb, 0x61, 0xac, 0x1d, 0x9d,
			    0xa8, 0xde, 0xc5, 0x59, 0xa5, 0x8e }
	},
	{
		.cipher_key_length = AES128_KEY_LEN,
		.cipher_key = { 0xc2, 0x86, 0x69, 0x6d, 0x88, 0x7c, 0x9a, 0xa0,
		...
		.ciphertext = { 0xd2, 0x96, 0xcd, 0x94, 0xc2, 0xcc, 0xcf, 0x8a,
				...
				0x1b, 0x82, 0x66, 0xbe, 0xa6, 0xd6, 0x1a, 0xb1},
		.digest_length = HMAC_SHA1_96_CHECK_LEN,
		.digest = { 0xbd, 0x3d, 0xc1, 0x35, 0x69, 0x5d,
			    0xa6, 0x92, 0x1d, 0xbf, 0xf9, 0x62 }
	},
	{
		.cipher_key_length = AES128_KEY_LEN,
		.cipher_key = { 0x6c, 0x3e, 0xa0, 0x47, 0x76, 0x30, 0xce, 0x21,
		...
		.ciphertext = { 0xd0, 0xa0, 0x2b, 0x38, 0x36, 0x45, 0x17, 0x53,
				...
				0x85, 0x79, 0x69, 0x5d, 0x83, 0xba, 0x26, 0x84},
		.digest_length = HMAC_SHA1_96_CHECK_LEN,
		.digest = { 0x5b, 0x66, 0x98, 0x2a, 0x06, 0x22,
			    0x75, 0xa2, 0xb9, 0x06, 0xca, 0x91 }
	},
	{
		.cipher_key_length = AES128_KEY_LEN,
		.cipher_key = { 0x56, 0xe4, 0x7a, 0x38, 0xc5, 0x59, 0x89, 0x74,
		...
		.cipher_iv = { 0x8c, 0xe8, 0x2e, 0xef, 0xbe, 0xa0, 0xda, 0x3c,
			       0x44, 0x69, 0x9e, 0xd7, 0xdb, 0x51, 0xb7, 0xd9 },
		.auth_key_length = HMAC_SHA1_KEY_LEN,
		.auth_key = { 0x0c, 0x0c, 0x0c, 0x0c, 0x0c, 0x0c, 0x0c, 0x0c,
		...
		.ciphertext = { 0xc3, 0x0e, 0x32, 0xff, 0xed, 0xc0, 0x77, 0x4e,
				...
				0x49, 0xa5, 0x3e, 0x87, 0xf4, 0xc3, 0xda, 0x55},
		.digest_length = HMAC_SHA1_96_CHECK_LEN,
		.digest = { 0x7f, 0x6c, 0x87, 0x61, 0xc8, 0xb2,
			    0xfe, 0xa3, 0xc6, 0x46, 0x86, 0xc2 }
	},
	{
		.cipher_key_length = AES128_KEY_LEN,
		.cipher_key = { 0x06, 0xa9, 0x21, 0x40, 0x36, 0xb8, 0xa1, 0x5b,
		...
		.ciphertext = { 0xe3, 0x53, 0x77, 0x9c, 0x10, 0x79, 0xae, 0xb8,
				0x27, 0x08, 0x94, 0x2d, 0xbe, 0x77, 0x18, 0x1a},
		.digest_length = HMAC_SHA1_CHECK_LEN,
		.digest = { 0xa9, 0xcb, 0x61, 0xac, 0x1d, 0x9d, 0xa8, 0xde,
			    0xc5, 0x59, 0xa5, 0x8e, 0xb4, 0x63, 0x01, 0x9f,
			    0x0c, 0x1b, 0x0b, 0x41 }
	},
	{
		.cipher_key_length = AES128_KEY_LEN,
		...
		.ciphertext = { 0xd2, 0x96, 0xcd, 0x94, 0xc2, 0xcc, 0xcf, 0x8a,
				...
				0x1b, 0x82, 0x66, 0xbe, 0xa6, 0xd6, 0x1a, 0xb1},
		.digest_length = HMAC_SHA1_CHECK_LEN,
		.digest = { 0xbd, 0x3d, 0xc1, 0x35, 0x69, 0x5d, 0xa6, 0x92,
			    0x1d, 0xbf, 0xf9, 0x62, 0x0c, 0x60, 0xc3, 0x95,
			    0x60, 0x40, 0x95, 0x41 }
	},
	{
		.cipher_key_length = AES128_KEY_LEN,
		...
		.ciphertext = { 0xd0, 0xa0, 0x2b, 0x38, 0x36, 0x45, 0x17, 0x53,
				...
				0x85, 0x79, 0x69, 0x5d, 0x83, 0xba, 0x26, 0x84},
		.digest_length = HMAC_SHA1_CHECK_LEN,
		.digest = { 0x5b, 0x66, 0x98, 0x2a, 0x06, 0x22, 0x75, 0xa2,
			    0xb9, 0x06, 0xca, 0x91, 0xef, 0xc9, 0xf9, 0xdc,
			    0x71, 0xf6, 0xc8, 0xfc }
	},
	{
		.cipher_key_length = AES128_KEY_LEN,
		...
		.ciphertext = { 0xc3, 0x0e, 0x32, 0xff, 0xed, 0xc0, 0x77, 0x4e,
				...
				0x49, 0xa5, 0x3e, 0x87, 0xf4, 0xc3, 0xda, 0x55},
		.digest_length = HMAC_SHA1_CHECK_LEN,
		.digest = { 0x7f, 0x6c, 0x87, 0x61, 0xc8, 0xb2, 0xfe, 0xa3,
			    0xc6, 0x46, 0x86, 0xc2, 0x91, 0x5c, 0x22, 0x7f,
			    0x3d, 0x0c, 0x4c, 0xeb }
	}
};

static crypto_test_reference_t aes_cbc_hmac_sha256_reference[] = {
	{
		.cipher_key_length = AES128_KEY_LEN,
		.cipher_key = { 0x06, 0xa9, 0x21, 0x40, 0x36, 0xb8, 0xa1, 0x5b,
				0x51, 0x2e, 0x03, 0xd5, 0x34, 0x12, 0x00, 0x06},
		...
		.ciphertext = { 0xe3, 0x53, 0x77, 0x9c, 0x10, 0x79, 0xae, 0xb8,
				0x27, 0x08, 0x94, 0x2d, 0xbe, 0x77, 0x18, 0x1a},
		.digest_length = HMAC_SHA256_128_CHECK_LEN,
		.digest = { 0xa7, 0xaf, 0x84, 0x7e, 0x38, 0xcf, 0xf8, 0x5e,
			    0x55, 0x11, 0x9d, 0xe7, 0xe5, 0x58, 0x71, 0x5c }
	},
	{
		.cipher_key_length = AES128_KEY_LEN,
		.cipher_key = { 0xc2, 0x86, 0x69, 0x6d, 0x88, 0x7c, 0x9a, 0xa0,
		...
		.ciphertext = { 0xd2, 0x96, 0xcd, 0x94, 0xc2, 0xcc, 0xcf, 0x8a,
				...
				0x1b, 0x82, 0x66, 0xbe, 0xa6, 0xd6, 0x1a, 0xb1},
		.digest_length = HMAC_SHA256_128_CHECK_LEN,
		.digest = { 0x53, 0x81, 0x79, 0x40, 0x10, 0x46, 0xdb, 0x92,
			    0xff, 0x24, 0x3b, 0x6c, 0x98, 0x47, 0xb4, 0x59 }
	},
	{
		.cipher_key_length = AES128_KEY_LEN,
		.cipher_key = { 0x6c, 0x3e, 0xa0, 0x47, 0x76, 0x30, 0xce, 0x21,
		...
		.ciphertext = { 0xd0, 0xa0, 0x2b, 0x38, 0x36, 0x45, 0x17, 0x53,
				...
				0x85, 0x79, 0x69, 0x5d, 0x83, 0xba, 0x26, 0x84},
		.digest_length = HMAC_SHA256_128_CHECK_LEN,
		.digest = { 0x74, 0xc9, 0xae, 0x1e, 0xc0, 0x30, 0x18, 0xee,
			    0x05, 0x3e, 0x19, 0xc7, 0xaa, 0xb1, 0xda, 0xd4 }
	},
	{
		.cipher_key_length = AES128_KEY_LEN,
		.cipher_key = { 0x56, 0xe4, 0x7a, 0x38, 0xc5, 0x59, 0x89, 0x74,
		...
		.ciphertext = { 0xc3, 0x0e, 0x32, 0xff, 0xed, 0xc0, 0x77, 0x4e,
				...
				0x49, 0xa5, 0x3e, 0x87, 0xf4, 0xc3, 0xda, 0x55},
		.digest_length = HMAC_SHA256_128_CHECK_LEN,
		.digest = { 0xda, 0x15, 0x7a, 0xf9, 0x48, 0x2f, 0xae, 0xa6,
			    0x17, 0xf8, 0xbd, 0x2e, 0xa7, 0x68, 0xe0, 0xb9 }
	},
	{
		.cipher_key_length = AES128_KEY_LEN,
		.cipher_key = { 0x06, 0xa9, 0x21, 0x40, 0x36, 0xb8, 0xa1, 0x5b,
		...
		.digest = { 0xa7, 0xaf, 0x84, 0x7e, 0x38, 0xcf, 0xf8, 0x5e,
			    0x55, 0x11, 0x9d, 0xe7, 0xe5, 0x58, 0x71, 0x5c,
			    0xf2, 0x1a, 0xc4, 0x2b, 0x97, 0x4a, 0x51, 0xf9,
			    0xe5, 0x96, 0x60, 0xf6, 0x8d, 0xbe, 0x9d, 0x0b }
	},
	{
		.cipher_key_length = AES128_KEY_LEN,
		.cipher_key = { 0xc2, 0x86, 0x69, 0x6d, 0x88, 0x7c, 0x9a, 0xa0,
		...
		.digest = { 0x53, 0x81, 0x79, 0x40, 0x10, 0x46, 0xdb, 0x92,
			    0xff, 0x24, 0x3b, 0x6c, 0x98, 0x47, 0xb4, 0x59,
			    0x6a, 0xb2, 0x51, 0x05, 0xbe, 0xf8, 0x78, 0xcc,
			    0xf0, 0x95, 0x73, 0x26, 0x29, 0x7f, 0xb3, 0x8e }
	},
	{
		.cipher_key_length = AES128_KEY_LEN,
		.cipher_key = { 0x6c, 0x3e, 0xa0, 0x47, 0x76, 0x30, 0xce, 0x21,
		...
		.digest = { 0x74, 0xc9, 0xae, 0x1e, 0xc0, 0x30, 0x18, 0xee,
			    0x05, 0x3e, 0x19, 0xc7, 0xaa, 0xb1, 0xda, 0xd4,
			    0xd1, 0xe8, 0xf2, 0x7c, 0x45, 0x58, 0xf3, 0x48,
			    0xf5, 0x41, 0x3b, 0x2d, 0x5a, 0x57, 0x73, 0x45 }
	},
	{
		.cipher_key_length = AES128_KEY_LEN,
		.cipher_key = { 0x56, 0xe4, 0x7a, 0x38, 0xc5, 0x59, 0x89, 0x74,
		...
		.digest = { 0xda, 0x15, 0x7a, 0xf9, 0x48, 0x2f, 0xae, 0xa6,
			    0x17, 0xf8, 0xbd, 0x2e, 0xa7, 0x68, 0xe0, 0xb9,
			    0x3d, 0xe3, 0xec, 0xcf, 0x88, 0x14, 0x00, 0x5b,
			    0xea, 0x35, 0x6f, 0x80, 0x96, 0x5e, 0xe0, 0xdb }
	}
};
