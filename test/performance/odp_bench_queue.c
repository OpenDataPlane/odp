...
static int schedule_empty(void)
{
	odp_event_t *dst = gbl_args->data.evs;
...
static int schedule_empty_tm(bench_tm_result_t *res, int repeat_count)
{
	bench_tm_stamp_t s1, s2;
	odp_event_t *dst = gbl_args->data.evs;
...
static int schedule_multi_nw_empty(void)
{
	odp_event_t *dst = gbl_args->data.evs;
	const int num_burst = gbl_args->appl.burst_size;
	int num_recv = 0;
...
static int schedule_multi_nw_empty_tm(bench_tm_result_t *res, int repeat_count)
{
	bench_tm_stamp_t s1, s2;
	odp_event_t *dst = gbl_args->data.evs;
	const int num_burst = gbl_args->appl.burst_size;
...
static int schedule_multi_empty(void)
{
	odp_event_t *dst = gbl_args->data.evs;
	const int num_burst = gbl_args->appl.burst_size;
	int num_recv = 0;
...
static int schedule_multi_empty_tm(bench_tm_result_t *res, int repeat_count)
{
	bench_tm_stamp_t s1, s2;
	odp_event_t *dst = gbl_args->data.evs;
	const int num_burst = gbl_args->appl.burst_size;
...
static int schedule_full_tm(bench_tm_result_t *res, int repeat_count)
{
	bench_tm_stamp_t s1, s2;
	odp_event_t *dst = gbl_args->data.evs;
	const uint8_t id1 = bench_tm_func_register(res, "odp_schedule()");
...
static int schedule_multi_nw_full(void)
{
	odp_event_t *dst = gbl_args->data.evs;
	const int num_burst = gbl_args->appl.burst_size;
	int num_recv = 0;
...
static int schedule_multi_nw_full_tm(bench_tm_result_t *res, int repeat_count)
{
	bench_tm_stamp_t s1, s2;
	odp_event_t *dst = gbl_args->data.evs;
	const int num_burst = gbl_args->appl.burst_size;
...
static int schedule_multi_full(void)
{
	odp_event_t *dst = gbl_args->data.evs;
	const int num_burst = gbl_args->appl.burst_size;
	int num_recv = 0;
...
static int schedule_multi_full_tm(bench_tm_result_t *res, int repeat_count)
{
	bench_tm_stamp_t s1, s2;
	odp_event_t *dst = gbl_args->data.evs;
	const int num_burst = gbl_args->appl.burst_size;
...
bench_info_t test_suite[] = {
	BENCH_INFO(context_set_plain, NULL, NULL),
	BENCH_INFO(context_plain, NULL, NULL),
	BENCH_INFO(context_set_scheduled, NULL, NULL),
	BENCH_INFO(context_scheduled, NULL, NULL),
	BENCH_INFO(enqueue_plain, init_src_events, term_src_events),
	BENCH_INFO(enqueue_multi_plain, init_src_events, term_src_events),
	BENCH_INFO(dequeue_plain, fill_plain_queues, term_dst_events),
	BENCH_INFO(dequeue_multi_plain, fill_plain_queues, term_dst_events),
	BENCH_INFO(enqueue_scheduled, init_src_events, term_scheduled_src_events),
	BENCH_INFO(enqueue_multi_scheduled, init_src_events, term_scheduled_src_events),
	BENCH_INFO(schedule_empty, init_events, term_events),
	BENCH_INFO(schedule_multi_nw_empty, init_events, term_events),
	BENCH_INFO(schedule_multi_empty, init_events, term_events),
	BENCH_INFO(schedule_full, fill_scheduled_queues, term_scheduled_dst_events),
	BENCH_INFO(schedule_multi_nw_full, fill_scheduled_queues, term_scheduled_dst_events),
	BENCH_INFO(schedule_multi_full, fill_scheduled_queues, term_scheduled_dst_events),
};
...
bench_tm_info_t test_suite_tm[] = {
	BENCH_INFO_TM(context_set_plain_tm, NULL, NULL),
	BENCH_INFO_TM(context_plain_tm, NULL, NULL),
	BENCH_INFO_TM(context_set_scheduled_tm, NULL, NULL),
	BENCH_INFO_TM(context_scheduled_tm, NULL, NULL),
	BENCH_INFO_TM(enqueue_plain_tm, init_src_events, term_src_events),
	BENCH_INFO_TM(enqueue_multi_plain_tm, init_src_events, term_src_events),
	BENCH_INFO_TM(dequeue_plain_tm, fill_plain_queues, term_dst_events),
	BENCH_INFO_TM(dequeue_multi_plain_tm, fill_plain_queues, term_dst_events),
	BENCH_INFO_TM(enqueue_scheduled_tm, init_src_events, term_scheduled_src_events),
	BENCH_INFO_TM(enqueue_multi_scheduled_tm, init_src_events, term_scheduled_src_events),
	BENCH_INFO_TM(schedule_empty_tm, init_events, term_events),
	BENCH_INFO_TM(schedule_multi_nw_empty_tm, init_events, term_events),
	BENCH_INFO_TM(schedule_multi_empty_tm, init_events, term_events),
	BENCH_INFO_TM(schedule_full_tm, fill_scheduled_queues, term_scheduled_dst_events),
	BENCH_INFO_TM(schedule_multi_nw_full_tm, fill_scheduled_queues, term_scheduled_dst_events),
	BENCH_INFO_TM(schedule_multi_full_tm, fill_scheduled_queues, term_scheduled_dst_events),
};
...
static void set_defaults(void)
{
	...
	gbl_args->appl.cache_size = -1; /* Use whatever param init defaults to */
...
static void print_usage(char *progname)
{
	printf("\n"
	       ...
	       "                         limit the value.\n"
	       "  -c, --cache_size <num> Pool cache size. Implementation default by default.\n"
...
static void parse_args(int argc, char *argv[])
{
	...
	static const char *shortopts =  "b:c:i:r:t:m:h";
...
static int create_resources(void)
{
	...
	if (gbl_args->appl.cache_size >= 0)
		p_param.buf.cache_size = gbl_args->appl.cache_size;
